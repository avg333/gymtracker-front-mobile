<template>
  <div class="row items-center full-space q-col-gutter-sm">
    ...
    <div class="col-3 text-center">
      <IncrementDecrementButtons
        :numberValue="Number(state.weight)"
  ...
  <div class="row items-center full-space q-col-gutter-sm">
    ...
    <div class="col-3 text-center">
      <IncrementDecrementButtons
        :numberValue="Number(state.reps)"
        @increment="state.reps += 1"
        @decrement="state.reps -= 1"
        @setZero="state.reps = 0"
      />
    </div>
  </div>
  ...
  <div class="full-space" v-if="state.weight && state.reps">
    ...
    <div
      ...
      v-for="(calculator, idx) in state.calculators"
      :key="idx"
    >
